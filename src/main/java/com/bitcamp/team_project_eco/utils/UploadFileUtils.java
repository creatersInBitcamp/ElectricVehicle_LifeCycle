...
public class UploadFileUtils {
    ...
    private static final String contextPath = "https://evcar.s3.ap-northeast-2.amazonaws.com"; // 앞에 버킷네임 teamev911 수정.
    private static final String bucketName = "evcar"; //AWS S3 생성한 버킷네임.
